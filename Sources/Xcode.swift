...
@objc public protocol XcodeDevice: SBObjectProtocol, XcodeGenericMethods {
    ...
    @objc optional var generic: Bool { get } // Whether this run destination is generic instead of representing a specific device. Most destinations are not generic, but a generic destination (such as "Generic iOS Device") will be available for some platforms if no physical devices are connected.
}
